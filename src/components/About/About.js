...
const About = () => {
  ...
  return (
    <section className="max-w-[1400px] my-0 mx-auto pt-[50px]" id="about">
      <h1
        className="text-[#1E4B85] text-[60px] font-bold leading-[75px] text-center max-[900px]:text-[60px] max-[520px]:text-[30px] max-[450px]:text-[35px] max-[400px]:leading-[40px]"
        style={{ fontFamily: "'Comfortaa', sans-serif" }}
      >
        {t("About Us")}
      </h1>
      <div className="flex justify-center gap-[30px] items-center py-[50px] px-0 flex-wrap max-[400px]:mx-[30px]">
        <div>
          <iframe
