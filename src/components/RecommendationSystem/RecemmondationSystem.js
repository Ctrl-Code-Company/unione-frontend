...
import styles from "./RecommendationSystem.module.css";
...
const fetchUniversities = async (page, pageSize, searchQuery) => {
  try {
    let url = `recomendation/university/`;
...
export default RecemmondationSystem;
